...
function Question (props) {
    ...
    return (
        <div class='bg-quatrefoil h-screen'>
            ...
            <div class={`mb-8 w-60  ${boxStyling}`}>
            ...
            <div class='grid grid-cols-4 gap-4 place-items-center mb-14 h-40'>
                {clues.length > 0 && <Clue cluesVisible={clues.length} clueToDisplay={questionToDisplay.clue1} meterValue={meterValue} points={5} displayMeter={1}/>}
                {clues.length > 1 && <Clue cluesVisible={clues.length} clueToDisplay={questionToDisplay.clue2} meterValue={meterValue} points={3} displayMeter={2}/>}
                {clues.length > 2 && <Clue cluesVisible={clues.length} clueToDisplay={questionToDisplay.clue3} meterValue={meterValue} points={2} displayMeter={3}/>}
                {clues.length > 3 && <Clue cluesVisible={clues.length} clueToDisplay={questionToDisplay.clue4} meterValue={meterValue} points={1} displayMeter={4}/>}
            ...
            <div class='mb-4 grid grid-cols-3 place-items-center w-full'>
                <div class='w-full'>
                    <div class='relative'>
                        ...
                        <p class='mt-3 left-32 absolute'>{playerScore.player1}</p>
                ...
                <div class='w-full'>
                    <div class='relative'>
                        ...
                        <p class='mt-3 right-32 absolute'>{playerScore.player2}</p>
            ...
            <div class='mb-0'>
                <button class={`h-12 px-4 ${boxStyling}`} onClick={pauseGame}>Pause game</button>
            </div>
